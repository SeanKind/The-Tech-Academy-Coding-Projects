...
create table tblPersons ( 
	personsId int primary key NOT NULL identity (1,1),
	personsFname varchar(50) NOT NULL,
	personsLname varchar(50) NOT NULL,
	personsContact varchar(50) NOT NULL
);

insert into tblPersons
	(personsFname, personsLname, personsContact)
	values
